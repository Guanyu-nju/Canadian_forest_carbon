...
for year=2015:2023
    ...
    NNE_mean_temp=importdata(['E:\phd_file\Boreal_North_America\Prior and posterior fluxes at 1deg resolution\Mean_value\month\NEE_' num2str(year) '_6.tif']);
    ...
    NNE_mean_temp=importdata(['E:\phd_file\Boreal_North_America\Prior and posterior fluxes at 1deg resolution\Mean_value\month\NEE_' num2str(year) '_7.tif']);
    ...
    NNE_mean_temp=importdata(['E:\phd_file\Boreal_North_America\Prior and posterior fluxes at 1deg resolution\Mean_value\month\NEE_' num2str(year) '_8.tif']);
...
June_NEE2023=importdata("E:\phd_file\Boreal_North_America\Prior and posterior fluxes at 1deg resolution\Mean_value\month\NEE_2023_6.tif").*pixel_mask;
June_GPP2023=importdata("E:\phd_file\Boreal_North_America\GPP\mean_value\month\GPP_2023_6.tif").*pixel_mask;
June_ER2023=importdata("E:\phd_file\Boreal_North_America\ER\month\ER_2023_6.tif").*pixel_mask;

July_NEE2023=importdata("E:\phd_file\Boreal_North_America\Prior and posterior fluxes at 1deg resolution\Mean_value\month\NEE_2023_7.tif").*pixel_mask;
July_GPP2023=importdata("E:\phd_file\Boreal_North_America\GPP\mean_value\month\GPP_2023_7.tif").*pixel_mask;
July_ER2023=importdata("E:\phd_file\Boreal_North_America\ER\month\ER_2023_7.tif").*pixel_mask;

Aug_NEE2023=importdata("E:\phd_file\Boreal_North_America\Prior and posterior fluxes at 1deg resolution\Mean_value\month\NEE_2023_8.tif").*pixel_mask;
Aug_GPP2023=importdata("E:\phd_file\Boreal_North_America\GPP\mean_value\month\GPP_2023_8.tif").*pixel_mask;
Aug_ER2023=importdata("E:\phd_file\Boreal_North_America\ER\month\ER_2023_8.tif").*pixel_mask;
...
m_patch(bou_canX,bou_canY,[225 225 227]/255,'linewidth',0.5); hold on% 填充矢量边界
% m_coast('patch',[.7 .7 .7],'edgecolor','none','linewidth',0.7); hold on
m_pcolor(lon1,lat1,June_GPP_2023Anomaly,'linestyle','none');
% m_plot(bou_canX,bou_canY,'linewidth',0.1,'color','k');% 填充矢量边界
m_grid('tickdir','in','FontName','Arial','xtick',[-150:30:-40],'ytick',[48:10:78],...
    'linewidth',0.7,'xaxisloc','bottom','yaxisloc','left','FontSize',14,'xticklabels',[-160:30:-40],'yticklabels',[48:10:78]); %对齐格网
c = redblue();
...
h=colorbar('location','eastoutside','FontName','Arial','FontSize',14,'ytick',[-80:40:80]);
set(get(h,'ylabel'),'string','gC m^{-2} month^{-1}','fontsize',14);
title('June GPP anomalies','FontName','Arial','FontSize',14,'fontweight','bold')
...
m_patch(bou_canX,bou_canY,[225 225 227]/255,'linewidth',0.5); hold on% 填充矢量边界
% m_coast('patch',[.7 .7 .7],'edgecolor','none','linewidth',0.7); hold on
m_pcolor(lon1,lat1,July_GPP_2023Anomaly,'linestyle','none');
% m_plot(bou_canX,bou_canY,'linewidth',0.1,'color','k');% 填充矢量边界
m_grid('tickdir','in','FontName','Arial','xtick',[-150:30:-40],'ytick',[48:10:78],...
    'linewidth',0.7,'xaxisloc','bottom','yaxisloc','left','FontSize',14,'xticklabels',[-160:30:-40],'yticklabels',[48:10:78]); %对齐格网
c = redblue();
...
h=colorbar('location','eastoutside','FontName','Arial','FontSize',14,'ytick',[-80:40:80]);
set(get(h,'ylabel'),'string','gC m^{-2} month^{-1}','fontsize',14);
title('July GPP anomalies','FontName','Arial','FontSize',14,'fontweight','bold')
...
m_patch(bou_canX,bou_canY,[225 225 227]/255,'linewidth',0.5); hold on% 填充矢量边界
% m_coast('patch',[.7 .7 .7],'edgecolor','none','linewidth',0.7); hold on
m_pcolor(lon1,lat1,Aug_GPP_2023Anomaly,'linestyle','none');
% m_plot(bou_canX,bou_canY,'linewidth',0.1,'color','k');% 填充矢量边界
m_grid('tickdir','in','FontName','Arial','xtick',[-150:30:-40],'ytick',[48:10:78],...
    'linewidth',0.7,'xaxisloc','bottom','yaxisloc','left','FontSize',14,'xticklabels',[-160:30:-40],'yticklabels',[48:10:78]); %对齐格网
c = redblue();
...
h=colorbar('location','eastoutside','FontName','Arial','FontSize',14,'ytick',[-80:40:80]);
set(get(h,'ylabel'),'string','gC m^{-2} month^{-1}','fontsize',14);
title('August GPP anomalies','FontName','Arial','FontSize',14,'fontweight','bold')
...
text('string','g','Units','normalized','position',[-0.0697588532029519 1.12202323328086 0],'FontName','Arial','FontSize',14,'fontweight','bold')
...
text('string','h','Units','normalized','position',[-0.0697588532029519 1.12202323328086 0],'FontName','Arial','FontSize',14,'fontweight','bold')
...
text('string','i','Units','normalized','position',[-0.0697588532029519 1.12202323328086 0],'FontName','Arial','FontSize',14,'fontweight','bold')

set(gcf,'unit','centimeters','position',[10.054166666666667,8.128,45.825833333333335,24.510999999999996]);
result=['E:\phd_file\Boreal_North_America\Result\V6\Flux_anomaly2023_June_July_Aug_map.png']
